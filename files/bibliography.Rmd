...
# Introduction
This example file uses the APA-like bibliography style. For an example of AMA-like bibliography, see [bibliography_ama.html](bibliography_ama.html) and its source code [bibliography_ama.Rmd](bibliography_ama.Rmd).
...
Page numbers can be included, and author can be suppressed by including a hyphen `-` before the `@` symbol:
...
__@Kang2013 ignored PA bouts with mean accelerometry counts $\ge$ 2863 per 30 s epoch.__
